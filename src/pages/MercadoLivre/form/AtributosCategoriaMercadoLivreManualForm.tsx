...
export const FormularioCategorias = ({ onCategoriaSelecionada }: Props) => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const categoria = categorias.find((cat) => cat.id === selectedId);
    if (categoria) {
  ...
  return (
    <form>
      ...
      <select id="categoria" value={categoriaId} onChange={handleChange}>
