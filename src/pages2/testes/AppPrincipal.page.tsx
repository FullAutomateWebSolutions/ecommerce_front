...
const items: MenuItem[] = [
  getItem("Cadastro de produto", "0", <PieChartOutlined />),
  ...
  // getItem("Relatório", "sub1", <PieChartOutlined />, [
  //   getItem("Lista de Associações", "945"),
  // ]),
  // getItem("Análise de falhas", "sub2", <DesktopOutlined />, [
  //   getItem("Falhas recente", "15"),
  //   getItem("Reprocessar falhas", "10"),
